...
running build - 518 KB of declarations, every event's input and result, every
...
`types/claude-code.d.ts` is the plugin API itself: 518 KB of declarations
...
`/plugin-types`, and the copy here is what 2.1.283 wrote. It is early access
