...
513 KB of TypeScript declarations for Claude Code's function-hooks plugin
...
you type `/plugin-types` in a session. The copy here is what build **2.1.281**
ships, read out of its binary on 2026-09-23 (the same text the command
